...
class EncoderCostVolume(Encoder[EncoderCostVolumeCfg]):
    ...
    def forward(
        ...
        #print("trans_features", trans_features)
        #print("trans_features shape ", trans_features.shape())
        extra_info = {}
        ...
        ###=====================HS's Code begin============================##
        raw_gaussians_1, raw_gaussians_2 = raw_gaussians.chunk(2, dim=-2)  # 두 개로 나누기

        # Gaussian 별로 독립적인 Feature 적용
        perturbation = torch.randn_like(raw_gaussians_1) * 0.01  # 작은 랜덤 변동 추가
        gaussians_1 = raw_gaussians_1 + perturbation
        gaussians_2 = raw_gaussians_2 - perturbation  # 반대 방향으로 변화
        
        raw_gaussians = torch.cat([gaussians_1, gaussians_2], dim=-2)  # 다시 합치기
